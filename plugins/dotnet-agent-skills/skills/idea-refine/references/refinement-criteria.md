...
- **Upstream**: https://github.com/addyosmani/agent-skills/blob/44dac80216da709913fb410f632a65547866346f/skills/idea-refine/refinement-criteria.md
- **Pinned commit**: `44dac80216da709913fb410f632a65547866346f` (synced 2026-04-19)
- **Status**: `as-is`
- **Changes**: None. The evaluation rubric, assumption audit, decision matrix, and MVP scoping principles are tech-agnostic and apply unchanged to .NET/C# ideation.
