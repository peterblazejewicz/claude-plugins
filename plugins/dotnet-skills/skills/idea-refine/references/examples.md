<!-- Copied verbatim from addyosmani/agent-skills (MIT © 2025 Addy Osmani). See "Source & Modifications" at the bottom of this file. -->
...
- **Upstream**: https://github.com/addyosmani/agent-skills/blob/44dac80216da709913fb410f632a65547866346f/skills/idea-refine/examples.md
- **Pinned commit**: `44dac80216da709913fb410f632a65547866346f` (synced 2026-04-19)
- **Status**: `as-is`
- **Changes**: None. Examples are tech-agnostic (restaurant business, document editor, team retrospectives) and teach the ideation rhythm directly. The `src/models/document.ts:45` reference in Example 2 is illustrative only — readers applying this to a .NET codebase will cite their own file paths.
