...
- `plugins/dotnet-skills/agents/{code-reviewer,security-auditor,test-engineer}.agent.md` — Copilot CLI forms of the same 3 personas (added in 2.5.0)
